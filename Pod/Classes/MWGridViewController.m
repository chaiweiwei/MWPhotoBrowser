...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    bool showSelectedButton = _selectionMode;
    if ([self.browser.delegate respondsToSelector:@selector(photoBrowser:canSelectedAtIndex:)]) {
        showSelectedButton = [self.browser.delegate photoBrowser:self.browser canSelectedAtIndex:indexPath.row];
    }
    ...
    cell.selectionMode = showSelectedButton;
